...
def github_create_repo() -> None:
    ...
    body_json = {"name": "tribbles", "description": "placeholder"}
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    ...
    url_public_key = (
        ...
        "/tribbles/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/tribbles/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    ...
    body_json = {
        "name": "tribbles",
        "repository": {
            "url": "https://github.com/Stephen-RA-King" "/tribbles",
            "type": "git",
        },
...
def readthedocs_update() -> None:
    ...
    url = "https://readthedocs.org/api/v3/projects/tribbles/"
    header = {"Authorization": f"token {READTHEDOCS_TOKEN}"}
...
def main() -> None:
    ...
    file_path = r"\tribbles\Lib\site-packages\semantic_release\repository.py"
    ...
    file_word_replace(tests, "package_name", "tribbles")
    logger.info(".... OK")
